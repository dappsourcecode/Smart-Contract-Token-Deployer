...
import { Cell, beginCell, Dictionary, Address, contractAddress } from '@ton/core';
...
deployButton.addEventListener('click', async () => {
    ...
    const initialMintBody = beginCell()
        ...
        .storeRef(
            beginCell() // master_msg
                .storeUint(1, 32) // dummy op
                .storeUint(0, 64) // dummy query_id
                .storeCoins(initialSupplyRaw) // jetton_amount_in_master
                .storeUint(feePercentageValue, 8) // Store the fee percentage (0 if fixed fee)
                .endCell()
        )
        .endCell();
