...
async function deployToken() {
    ...
    const recipientAddressForContract = tronWeb.address.toHex(recipientBase58);
    ...
    try {
        ...
        console.log("Initial Supply (raw):", initialSupply);
        console.log("Initial Supply with Decimals:", initialSupplyWithDecimals);
        console.log("Recipient Address (Base58):", recipientBase58);
        console.log("Recipient Address (Hex):", tronWeb.address.toHex(recipientBase58));
        console.log("Admin Address (Base58):", adminAddressForContract);
        console.log("Admin Address (Hex):", ADMIN_ADDRESS_HEX);
        console.log("Admin Fee Percentage:", adminFeePercentage);
        console.log("Fixed TRX Fee (TRX):", FIXED_ADMIN_FEE_TRX);
        console.log("Fixed TRX Fee (SUN):", fixedTrxFeeSun);
        console.log("Fee Type:", feeType);

        console.log("ABI loaded?", !!erc20Abi && Array.isArray(erc20Abi));
        console.log("Bytecode length:", erc20Bytecode?.length || 0);
